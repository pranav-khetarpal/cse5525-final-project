...
def get_args():
    ...
    parser.add_argument("--lags", type=int, default=5, help="Number of lags for AutoRegression")
    parser.add_argument("--window", type=int, default=5, help="Number of days for Window Size")
...
def main():
    ...
    results = evaluate_autoreg(train_df, val_df, args.lags)
